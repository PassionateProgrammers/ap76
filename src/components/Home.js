...
const Home = () => {
  return (
    <div className='pt-[80px]'>
      ...
      <div className='w-full md:max-w-[665px] mx-auto px-8 pt-48 pb-36 flex flex-col justify-center items-center relative z-20'>
        ...
        <div className='flex flex-col md:flex-row justify-center items-center pt-10 space-y-8 md:space-y-0'>
          <a href="/ap76/#/about" className='text-white text-md px-8 py-4 md:mr-6 border-2 border-white buttons'>ABOUT US</a>
          <a href="/ap76/#/what-we-do" className='text-white text-md px-8 py-4 border-2 buttons'>WHAT WE DO</a>
        </div>
      </div>
      <div className='flex max-w-full md:max-w-[1100px] mx-auto items-center justify-center pb-96 pt-48 lg:pb-0 lg:pt-0 px-0 md:px-8 lg:px-0'>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 justify-center h-[300px]">
        ...
        <div className='pt-48 flex flex-col-reverse lg:flex-row justify-center items-center lg:space-x-20'>
          <div className='flex-col max-w-full md:max-w-[550px] text-center lg:text-left px-4 lg:px-0'>
            ...
            <a href="/ap76/#/what-we-do" className='hover:text-white px-8 py-4 text-[#791414] border-2 border-[#791414] hover:bg-[#791414]'>LEARN MORE</a>
          </div>
          <div>
            <img className="w-full md:w-[459px] h-auto" src={veteran} alt="veteran"/>
          </div>
        </div>
        <div className='py-20 flex flex-col lg:flex-row justify-center items-center lg:space-x-20'>
          <div>
            <img className="w-full md:w-[459px] h-auto" src={veteran2} alt="veteran2"/>
          </div>
          <div className='flex-col max-w-full md:max-w-[550px] text-center lg:text-left px-4 lg:px-0'>
            <p className='text-gray-500 text-xs py-4'>AP76.ORG</p>
            ...
            <a href="/ap76/#/about" className='hover:text-white px-8 py-4 text-[#791414] border-2 border-[#791414] hover:bg-[#791414]'>LEARN MORE</a>
          </div>
        </div>
