    ...
    <div className='pt-[80px]'>
      ...
      <div className='max-w-[665px] mx-auto px-8 pt-48 pb-36 flex flex-col justify-center items-center relative z-20'>
        ...
        <div className='flex justify-between pt-10'>
          <a href="/ap76/#/about" className='text-white px-8 py-4 mr-6 border-2 border-white buttons'>ABOUT US</a>
          <a href="/ap76/#/what-we-do" className='text-white px-8 py-4 border-2 buttons'>WHAT WE DO</a>
        </div>
      </div>
